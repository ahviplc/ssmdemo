...
<body class="overflow-body">
	<div class="main-content padding-bottom100">
		...
		<div class="page-content">
			<p class="signup_title">公告修改</p>
			<form class="form-horizontal width600 margin-top30"  id="form-modifynotice" action="<%=contextPath %>/updateNotice.action" method="post">
				<input type="hidden" name="ntcid" value="${notice.ntcid}">
				<div class="form-group margin0">
					<label class="common-label width90"> 公告标题： </label>
					<div class="common-input width300">
					<input id="ntctopic" type="text" value="${notice.ntctopic}" required="required" maxlength="20" placeholder="请输入公告标题" name="ntctopic"  class="width-100 height35"/>
					</div>
				...
				<div class="form-group margin0">
					...
					<div class="common-input width300">
					<input id="ntccontent" type="text" value="${notice.ntccontent}" required="required" maxlength="12" placeholder="请输入公告内容" name="ntccontent"  class="width-100 height35"/>
					</div>
				...
				<div class="form-group margin0">
					...
					<div class="common-input width300">
					<input id="tchid" type="text" value="${notice.tchid}" readonly="readonly" maxlength="12" name="tchid"  class="width-100 height35"/>
					</div>

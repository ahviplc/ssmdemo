...
<div style="text-align:center;">
    <ul class="pagination">
        ...
        <c:if test="${!pagehelper.isFirstPage}">
            <li><a href="javascript:queryAllUser(${pagehelper.firstPage}, ${pagehelper.pageSize});">首页</a></li>
            <li><a href="javascript:queryAllUser(${pagehelper.prePage}, ${pagehelper.pageSize});">上一页</a></li>
        </c:if>
        <c:forEach items="${pagehelper.navigatepageNums}" var="navigatepageNum">
        
            <c:if test="${navigatepageNum==pagehelper.pageNum}">
                <li class="active"><a href="javascript:queryAllUser(${navigatepageNum}, ${pagehelper.pageSize});">${navigatepageNum}</a></li>
            </c:if>
            <c:if test="${navigatepageNum!=pagehelper.pageNum}">
                <li><a href="javascript:queryAllUser(${navigatepageNum}, ${pagehelper.pageSize});">${navigatepageNum}</a></li>
            </c:if>
        </c:forEach>
        <c:if test="${!pagehelper.isLastPage}">
            <li><a href="javascript:queryAllUser(${pagehelper.nextPage}, ${pagehelper.pageSize});">下一页</a></li>
            <li><a href="javascript:queryAllUser(${pagehelper.lastPage}, ${pagehelper.pageSize});">最后一页</a></li>
        </c:if>

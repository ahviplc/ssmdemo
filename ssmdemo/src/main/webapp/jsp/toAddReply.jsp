	...
	<div class="main-content padding-bottom100">
		<div class="breadcrumbs" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li><a href="listReply.action">评论管理</a></li>
				<li class="action">添加</li>
			</ul>
		</div>
		<div class="page-content">
			<p class="signup_title">评论添加</p>
			<form class="form-horizontal width600 margin-top30"  id="form-modifyreply" action="<%=contextPath %>/addReply.action" method="post">
				<div class="form-group margin0">
					<label class="common-label width90"> 评论课程ID： </label>
					<div class="common-input width300">
					<input id="crsid" type="text" required="required" maxlength="20" placeholder="请输入评论课程ID" name="crsid"  class="width-100 height35"/>
					</div>
				...
				<div class="form-group margin0">
					...
					<div class="common-input width300">
					<input id="content" type="text" required="required" maxlength="12" placeholder="请输入内容" name="content"  class="width-100 height35"/>
					</div>

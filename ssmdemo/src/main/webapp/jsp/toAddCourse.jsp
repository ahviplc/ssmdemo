...
<body class="overflow-body">
	<div class="main-content padding-bottom100">
		...
		<div class="page-content">
			<p class="signup_title">课程资源添加</p>
			<form class="form-horizontal width600 margin-top30" enctype="multipart/form-data"  id="form-modifycourse" action="<%=contextPath %>/addCourse.action" method="post">
				<div class="form-group margin0">
					<label class="common-label width90"> 课程标题： </label>
					<div class="common-input width300">
					<input id="crstopic" type="text" required="required" maxlength="50" placeholder="请输入课程标题" name="crstopic"  class="width-100 height35"/>
					</div>
				...
				<div class="form-group margin0">
					...
					<div class="common-input width300">
					<input id="crsurl" type="file" required="required" maxlength="50" placeholder="请输入课程url" name="file"  class="width-100 height35"/>
					</div>
				...
				<div class="form-group margin0">
					...
					<div class="common-input width300">
					 <select name="type" id="type" class="width-100 height35">   
			...
			<div class="form-group margin0">
					...
					<div class="easyui-panel form-group margin0" style="width:100%;max-width:310px;padding:30px 60px;">
		<div style="margin-bottom:20px">
			<input class="easyui-datetimebox" name="crstime" id="crstime" style="width:100%;">
		</div>
			...
			<div class="form-group margin0">
					...
					<div class="common-textarea width210">
						<textarea id="crsdescribe" maxlength="100" class="width-70" rows="8" placeholder="请输入课程描述" name="crsdescribe"></textarea>
					</div>

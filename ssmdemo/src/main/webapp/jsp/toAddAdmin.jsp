...
<body class="overflow-body">
	<div class="main-content padding-bottom100">
		...
		<div class="page-content">
			<p class="signup_title">管理员添加</p>
			<form class="form-horizontal width600 margin-top30"  id="form-modifyadmin" action="<%=contextPath %>/add2Admin.action" method="post">
				<div class="form-group margin0">
					<label class="common-label width90"> 用户名： </label>
					<div class="common-input width300">
					<input id="admusername" type="text" required="required" maxlength="20" placeholder="请输入用户名" name="admusername"  class="width-100 height35"/>
					</div>
				...
				<div class="form-group margin0">
					...
					<div class="common-input width300">
					<input id="admname" type="text" required="required" maxlength="20" placeholder="请输入用户名" name="admname"  class="width-100 height35"/>
					</div>
					<p class="tip-wrap common-tips margin-left100"><span id="username-tips"></span></p>
				</div>
				
					<div class="form-group margin0">
					<label class="common-label width90">登陆密码：</label>
					<div class="common-input width300">
					<input id="admpwd" type="password" required="required" maxlength="20" name="admpwd"  placeholder="请输入登陆密码" class="width-100 height35"/>
					</div>

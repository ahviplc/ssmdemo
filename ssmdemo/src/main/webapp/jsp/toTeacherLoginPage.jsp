	...
	<section class="main clearfix login">
		<div class="wrap-inputs">
			...
			<div id="login-content" class="content-box">
				...
				<h4 class="header lighter white"><i class="icon-user"></i>教师登录<%-- <font color="red">${msg}</font> --%>
				...
				<form name="alogin" action="<%=contextPath %>/tlogin.action" method="post" id="login-form">
					...
					<fieldset>
						<label class="block clearfix">
							<span class="block input-icon input-icon-right">
								<input type="text"  class="form-control" name="tchloginname" placeholder="教师账号" id="tchloginname">
								<i class="icon-user"></i>
							</span>
						...
						<label class="block clearfix">
							<span class="block input-icon input-icon-right">
								<input type="password"  class="form-control" name="tchpwd"  placeholder="教师密码" id="tchpwd">
								<i class="icon-lock"></i>
							</span>
			...
			<div id="signup-box" class="content-box none">
				...
				<h4 class="header lighter white"><i class="icon-group"></i>教师注册</h4>
			
				<form id="register-from" action="<%=contextPath %>/addTeacher.action" method="post">
					<fieldset>
						<label class="block clearfix">
							<span class="block input-icon input-icon-right">
								<input class="form-control" name="tchloginname" required="required"  placeholder="教师用户名" id="tchloginname"/>
						...
						<label class="block clearfix">
							<span class="block input-icon input-icon-right">
								<input class="form-control" name="tchnumber" required="required"  placeholder="教师工号" id="tchnumber"/>
								<i class="icon-username"></i>
							</span>
							<span id="user-emial-tips" class="tip-wrap white"></span>
						</label>
						...
						<label class="block clearfix">
							<span class="block input-icon input-icon-right">
								<input class="form-control" name="tchname" required="required"  placeholder="教师姓名" id="tchname"/>
								<i class="icon-username"></i>
							</span>
							<span id="user-emial-tips" class="tip-wrap white"></span>
						</label>
						...
						<label class="block clearfix">
							<span class="block input-icon input-icon-right">
								<input class="form-control" name="tchphone" required="required"  placeholder="教师手机" id="tchphone"/>
								<i class="icon-username"></i>
							</span>
							<span id="user-emial-tips" class="tip-wrap white"></span>
						</label>
						...
						<label class="block clearfix">
							<span class="block input-icon input-icon-right">
								<input class="form-control" name="tchmail" required="required"  placeholder="教师邮箱" id="tchmail"/>
								<i class="icon-username"></i>
							</span>
							<span id="user-emial-tips" class="tip-wrap white"></span>
						</label>
						...
						<label class="block clearfix">
							<span class="block input-icon input-icon-right">
								<input class="form-control" name="tchresearch" required="required"  placeholder="教师研究方向" id="tchresearch"/>
								<i class="icon-username"></i>
							</span>
							<span id="user-emial-tips" class="tip-wrap white"></span>
						</label>
						...
						<label class="block clearfix">
							<span class="block input-icon input-icon-right">
								<input type="password" class="form-control" required="required" name="tchpwd" placeholder="密码" id="tchpwd" />
								<i class="icon-lock"></i>
							</span>

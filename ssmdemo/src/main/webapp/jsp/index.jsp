...
<body>
 	<iframe id="top-iframe" src="<%=contextPath %>/jsp/top.jsp" name="top"></iframe>
	<iframe id="menu-iframe" src="<%=contextPath %>/login/menu.jsp" name="menu"></iframe>
	<iframe id="content-iframe" src="<%=contextPath %>/jsp/content.jsp" name="content"></iframe>

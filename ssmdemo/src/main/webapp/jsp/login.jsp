	...
	<section class="main clearfix login">
		<div class="wrap-inputs">
			...
			<div id="login-content" class="content-box">
				<h2 class="white subtitle" style="color:black;">ssm-demo后台登陆</h2>
				<h4 class="header lighter white"><i class="icon-user"></i>登录<font color="red">${msg}</font></h4>
				<form name="login" action="<%=contextPath %>/login.action" method="post" id="login-form">
				<input type="hidden" id="manual" name="manual" value="0"/>
					
					<fieldset>
						<label class="block clearfix">
							<span class="block input-icon input-icon-right">
								<input type="text"  class="form-control" name="username" placeholder="账号" id="userId">
								<i class="icon-user"></i>
							</span>
						...
						<div class="clearfix">
							...
							<button id="login-btn" class="width-100 pull-right btn btn-sm btn-primary" type="button"><i class="icon-key"></i>登录</button>
						</div>
					</fieldset>
				</form>
			...
			<div id="signup-box" class="content-box none">
				...
				<form id="register-from" action="<%=contextPath %>/addUser.action" method="post">
					<fieldset>
						<label class="block clearfix">
							<span class="block input-icon input-icon-right">
								<input class="form-control" name="email" placeholder="用户名" id="user-emial"/>
						...
						<label class="block clearfix">
							<span class="block input-icon input-icon-right">
								<input type="password" class="form-control" name="password" placeholder="密码" id="user-password" />
								<i class="icon-lock"></i>
							</span>
